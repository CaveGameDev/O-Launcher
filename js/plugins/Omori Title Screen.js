...
Scene_OmoriTitleScreen.prototype.createTitleCommands = function() {
  ...
  // Set Continue text (first command now that NEW GAME was removed)
  this._titleCommands[0].setText(textList[0], this._canContinue);
  ...
  if (this._commandActive && !this.move.isMoving()) {
    ...
    if (Input.isTriggered('ok')) {
      ...
      switch (this._commandIndex) {
        case 0: // Continue (NEW GAME button removed)
